...
public class DefaultActionItem implements ActionItem {
     ...
     */
    public DefaultActionItem(int actionId, String title, Drawable icon) {
        this.title = title;
        this.icon = icon;
     ...
     */
    public DefaultActionItem(int actionId, String title) {
     ...
     */
    public DefaultActionItem(Drawable icon) {
        this(-1, null, icon);
    }
     ...
     * @param icon      {@link Drawable} action icon
     */
    public DefaultActionItem(int actionId, Drawable icon) {
	...
	public View getView(LayoutInflater inflater, int orientation) {
		...
		if (orientation == QuickAction.HORIZONTAL) {
